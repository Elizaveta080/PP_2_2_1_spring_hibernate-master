...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      userService.add(new Car("A", 111));
      userService.add(new Car("B", 222));
      userService.add(new Car("C", 333));
      userService.add(new Car("D", 4444));
      ...
      User findedUser = userService.findUser("A", 111);
